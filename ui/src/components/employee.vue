...
<div>
    ...
    <tbody>
        <tr v-for="emp in employees" :key="`first-${emp.EmployeeId}`">
            ...
            <div class="p-2 w-50 bd-highlight">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" v-model="Department">
                        <option v-for="dep in departments" :key="`second-${dep.DepartmentId}`">
                        {{dep.DepartmentName}}
                        </option>
                    </select>
                </div>
...
import Header from "../components/Header.vue"
    ...
    data(){
        return{
            ...
            PhotoPath:"https://localhost:7049/photos/"
        }
    },
    methods:{
        refreshData(){
            ...
            axios.get("department",{ withCredentials: true })
            .then((response)=>{
        ...
        deleteClick(id){
            ...
            axios.delete("employee/"+id,{ withCredentials: true })
            .then((response)=>{
                this.refreshData();
                alert(response.data);
            });
